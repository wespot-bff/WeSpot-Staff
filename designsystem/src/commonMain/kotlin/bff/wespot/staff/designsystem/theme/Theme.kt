package bff.wespot.staff.designsystem.theme
...
private val CustomDarkColors = CustomColors(
    ...
    disableBtnTxtColor = Gray300,
    secondaryBtnColor = Gray500,
    primaryBtnColor = Primary300,
    disableBtnColor = Gray500,
    badgeColor = Gray500,
    modalColor = Gray600,
    bottomSheetColor = Gray600,
...
fun WeSpotTheme(
    ...
    CustomLocalProvider(colors = colors) {
        MaterialTheme(
            ...
            content = content,
            typography = StaticTypography().Copy(),
            shapes = Shapes,
        )
    }
}
